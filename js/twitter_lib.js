function TwitterLib(requestTimeout, onAuthenticated, onHitsUpdated, baseUrl, baseAuthorizeUrl, baseSigningUrl) {
  ...
  var _this = this;
  this.oauthLib = new TwitterOAuth(function() {
...
TwitterOAuth.prototype = {
  ...
  prepareSignedParams: function(url, params, httpMethod) {
    var accessor = {
      consumerSecret: '8QRvVySJeLzMX03rIRxLdPuWY82FuRXjQSu6q9vwnc',
    ...
    var message = {
      ...
      method: httpMethod,
      parameters: [
        ['oauth_consumer_key', 'CHPSVaD1m9oUiajld2o4Yw'],
